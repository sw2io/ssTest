...
namespace QCHT.Samples.Drawing
{
    public class PencilPointer : MonoBehaviour, IXRRayInteractorFilter
    {
        ...
        private readonly List<UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor> _rayInteractors = new List<UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor>();
        ...
        private void Awake()
        {
            ...
            {
                var rayInteractor = interactor as UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor;

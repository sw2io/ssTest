...
namespace QCHT.Interactions.UI
{
    public class XRSnapUIActivator : MonoBehaviour
    {
        ...
        private readonly List<UnityEngine.XR.Interaction.Toolkit.Interactables.XRBaseInteractable> _interactables = new List<UnityEngine.XR.Interaction.Toolkit.Interactables.XRBaseInteractable>();
        private readonly List<UnityEngine.XR.Interaction.Toolkit.Interactables.XRInteractableSnapVolume> _snapVolumes = new List<UnityEngine.XR.Interaction.Toolkit.Interactables.XRInteractableSnapVolume>();
        ...
        private void Awake()
        {
            ...
            _interactables.AddRange(GetComponentsInChildren<UnityEngine.XR.Interaction.Toolkit.Interactables.XRBaseInteractable>(true));
            _snapVolumes.AddRange(GetComponentsInChildren<UnityEngine.XR.Interaction.Toolkit.Interactables.XRInteractableSnapVolume>(true));

...
{
    [RequireComponent(typeof(UnityEngine.XR.Interaction.Toolkit.Interactors.XRGazeInteractor))]
    public class GazeInteractionUI : MonoBehaviour
    {
        ...
        private UnityEngine.XR.Interaction.Toolkit.Interactors.XRGazeInteractor _xrGazeInteractor;
